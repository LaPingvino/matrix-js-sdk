...
import { type Statistics, type RTCNotificationType, type Status, type IRTCNotificationContent, type ICallNotifyContent } from "./types.ts";
...
export declare class MatrixRTCSession extends TypedEventEmitter<MatrixRTCSessionEvent | RoomAndToDeviceEvents | MembershipManagerEvent, MatrixRTCSessionEventHandlerMap & RoomAndToDeviceEventsHandlerMap & MembershipManagerEventHandlerMap> {
     ...
     * oldest first.
     */
    static sessionMembershipsForRoom(room: Pick<Room, "getLiveTimeline" | "roomId" | "hasMembershipState">, sessionDescription: SessionDescription): CallMembership[];
    /**
     ...
     */
    static sessionForRoom(client: MatrixClient, room: Room, sessionDescription: SessionDescription): MatrixRTCSession;
    /**
