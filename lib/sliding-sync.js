 ...
 */
export var DEFAULT_SLIDING_SYNC_REQUIRED_STATE = [["m.room.create", ""], ["m.room.name", ""], ["m.room.avatar", ""], ["m.room.topic", ""], ["m.room.canonical_alias", ""], ["m.room.encryption", ""], ["m.room.member", MSC3575_STATE_KEY_ME], ["m.room.member", MSC3575_STATE_KEY_LAZY], ["m.space.parent", MSC3575_WILDCARD], ["org.matrix.msc3401.call.member", MSC3575_WILDCARD], ["m.rtc.member", MSC3575_WILDCARD], ["eu.kiefte.issues.schema", ""], ["eu.kiefte.issue", MSC3575_WILDCARD]];
...
export class SlidingSync extends TypedEventEmitter {
  ...
  static create(client) {
    var _opts$requiredState, _opts$spacesRequiredS, _opts$subscriptionReq, _opts$windowSize, _opts$growBy, _opts$timelineLimit, _opts$roomSubscriptio, _opts$timeoutMS;
    ...
    var spacesRequiredState = (_opts$spacesRequiredS = opts.spacesRequiredState) !== null && _opts$spacesRequiredS !== void 0 ? _opts$spacesRequiredS : DEFAULT_SLIDING_SYNC_SPACES_REQUIRED_STATE;
    ...
    var growBy = (_opts$growBy = opts.growBy) !== null && _opts$growBy !== void 0 ? _opts$growBy : 200;
    ...
    var ss = new SlidingSync(client.baseUrl, lists, roomSubscription, client, (_opts$timeoutMS = opts.timeoutMS) !== null && _opts$timeoutMS !== void 0 ? _opts$timeoutMS : 30000);
    ...
    ss.on(SlidingSyncEvent.Lifecycle, (state, _resp, err) => {
      ...
      for (var key of ["all", "spaces"]) {
        var _ss$getListParams$ran, _ss$getListParams;
        var _data = ss.getListData(key);
        ...
        if (_data && _data.joinedCount > end + 1) {
          ss.setListRanges(key, [[0, Math.min(end + growBy, _data.joinedCount)]]);
        }
      }
    });
    return ss;
