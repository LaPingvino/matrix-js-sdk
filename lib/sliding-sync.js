...
export class SlidingSync extends TypedEventEmitter {
  ...
  static create(client) {
    ...
    var ss = new SlidingSync(client.baseUrl, lists, roomSubscription, client, (_opts$timeoutMS = opts.timeoutMS) !== null && _opts$timeoutMS !== void 0 ? _opts$timeoutMS : 10000);
   ...
   */
  posStorageKey() {
    var _this$client$getUserI, _this$client$getDevic;
    ...
    return "mxjssdk_sss_pos_".concat(userId, "_").concat(deviceId);
  }
  restorePos() {
    try {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _loop = function* _loop() {
          ...
          try {
            ...
            var effectiveTimeout = boostPolls > 0 ? Math.min(BOOST_TIMEOUT_MS, _this5.timeoutMS) : _this5.timeoutMS;
