...
export class SlidingSync extends TypedEventEmitter {
  ...
  static create(client) {
    ...
    var requiredState = (_opts$requiredState = opts.requiredState) !== null && _opts$requiredState !== void 0 ? _opts$requiredState : [["*", "*"]];
    var spacesRequiredState = (_opts$spacesRequiredS = opts.spacesRequiredState) !== null && _opts$spacesRequiredS !== void 0 ? _opts$spacesRequiredS : requiredState;
    var subscriptionRequiredState = (_opts$subscriptionReq = opts.subscriptionRequiredState) !== null && _opts$subscriptionReq !== void 0 ? _opts$subscriptionReq : requiredState;
