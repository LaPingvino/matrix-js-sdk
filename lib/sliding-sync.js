      ...
      var _loop = function* _loop() {
          ...
          try {
            ...
            if (processingFailures >= 3) {
              ...
              logger.error("SlidingSync(".concat((_this5$connId = _this5.connId) !== null && _this5$connId !== void 0 ? _this5$connId : "main", "): response processing failed ").concat(processingFailures, "x; ") + "advancing pos past the poisoned batch", err);
              processingFailures = 0;
              currentPos = resp.pos;
              _this5.persistPos(currentPos);
            } else {
              ...
              logger.error("SlidingSync(".concat((_this5$connId2 = _this5.connId) !== null && _this5$connId2 !== void 0 ? _this5$connId2 : "main", "): response processing failed; ") + "keeping pos for redelivery (attempt ".concat(processingFailures, ")"), err);
