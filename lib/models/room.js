...
export class Room extends ReadReceipt {
  ...
  getDirectUserId() {
    ...
    var content = (_this$client$getAccou = this.client.getAccountData(EventType.Direct)) === null || _this$client$getAccou === void 0 ? void 0 : _this$client$getAccou.getContent();
