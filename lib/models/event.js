...
export class MatrixEvent extends TypedEventEmitter {
   ...
   */
  getUrlPreviews() {
    var _content$mUrl_previe;
    var content = this.getContent();
    var previews = (_content$mUrl_previe = content["m.url_previews"]) !== null && _content$mUrl_previe !== void 0 ? _content$mUrl_previe : content["com.beeper.linkpreviews"];
