      ...
      yield promiseMapSeries(joinRooms, /*#__PURE__*/function () {
        var _ref8 = _asyncToGenerator(function* (joinObj) {
          ...
          try {
            ...
            var _room$roomId;
            _this9.syncOpts.logger.error("Failed to process joined room ".concat((_room$roomId = room === null || room === void 0 ? void 0 : room.roomId) !== null && _room$roomId !== void 0 ? _room$roomId : "?", " during sync; skipping it"), e);
          }
        });
        return function (_x4) {
