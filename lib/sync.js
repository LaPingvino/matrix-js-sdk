      ...
      yield promiseMapSeries(inviteRooms, /*#__PURE__*/function () {
        var _ref7 = _asyncToGenerator(function* (inviteObj) {
          ...
          try {
            ...
            var _room$roomId;
            _this9.syncOpts.logger.error("Failed to process invited room ".concat((_room$roomId = room === null || room === void 0 ? void 0 : room.roomId) !== null && _room$roomId !== void 0 ? _room$roomId : "?", " during sync; skipping it"), e);
          }
        });
        return function (_x3) {
      ...
      yield promiseMapSeries(joinRooms, /*#__PURE__*/function () {
        var _ref8 = _asyncToGenerator(function* (joinObj) {
          ...
          try {
            ...
            var _room$roomId2;
            _this9.syncOpts.logger.error("Failed to process joined room ".concat((_room$roomId2 = room === null || room === void 0 ? void 0 : room.roomId) !== null && _room$roomId2 !== void 0 ? _room$roomId2 : "?", " during sync; skipping it"), e);
          }
        });
        return function (_x4) {
      ...
      yield promiseMapSeries(leaveRooms, /*#__PURE__*/function () {
        var _ref9 = _asyncToGenerator(function* (leaveObj) {
          ...
          try {
            ...
            var _room$roomId3;
            _this9.syncOpts.logger.error("Failed to process left room ".concat((_room$roomId3 = room === null || room === void 0 ? void 0 : room.roomId) !== null && _room$roomId3 !== void 0 ? _room$roomId3 : "?", " during sync; skipping it"), e);
          }
        });
        return function (_x5) {
      ...
      yield promiseMapSeries(knockRooms, /*#__PURE__*/function () {
        var _ref0 = _asyncToGenerator(function* (knockObj) {
          ...
          try {
            ...
            var _room$roomId4;
            _this9.syncOpts.logger.error("Failed to process knocked room ".concat((_room$roomId4 = room === null || room === void 0 ? void 0 : room.roomId) !== null && _room$roomId4 !== void 0 ? _room$roomId4 : "?", " during sync; skipping it"), e);
          }
        });
        return function (_x6) {
...
export function _createAndReEmitRoom(client, roomId, opts) {
  ...
  client.reEmitter.reEmit(room, [RoomEvent.Name, RoomEvent.Redaction, RoomEvent.RedactionCancelled, RoomEvent.Receipt, RoomEvent.Tags, RoomEvent.LocalEchoUpdated, RoomEvent.AccountData, RoomEvent.MyMembership, RoomEvent.Timeline, RoomEvent.TimelineReset, RoomEvent.UnreadNotifications, RoomStateEvent.Events, RoomStateEvent.Members, RoomStateEvent.NewMember, RoomStateEvent.Update, BeaconEvent.New, BeaconEvent.Update, BeaconEvent.Destroy, BeaconEvent.LivenessChange]);
