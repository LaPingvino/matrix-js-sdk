...
import { SlidingSync } from "./sliding-sync.js";
...
export class MatrixClient extends TypedEventEmitter {
  ...
  startClient(opts) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (!_this2.clientOpts.slidingSync && _this2.clientOpts.autoSlidingSync !== false) {
        if (yield _this2.serverSupportsSimplifiedSlidingSync()) {
          var _this2$clientOpts$sli;
          _this2.logger.info("Auto-enabling simplified sliding sync (server advertises MSC4186/MSC3575)");
          _this2.clientOpts.slidingSync = SlidingSync.create(_this2, (_this2$clientOpts$sli = _this2.clientOpts.slidingSyncOpts) !== null && _this2$clientOpts$sli !== void 0 ? _this2$clientOpts$sli : {});
        }
      }
  ...
  isRoomLiveSynced(roomId) {
    ...
    return api !== null && api !== void 0 && api.hasLiveSynced ? api.hasLiveSynced(roomId) : true;
  }
  ...
  sendReceipt(event, receiptType, body) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var guardRoom = _this20.getRoom(event.getRoomId());
      if (guardRoom && _this20.credentials.userId && (unthreaded || threadIdForReceipt(event) === MAIN_ROOM_TIMELINE) && typeof guardRoom.wouldRegressReceipt === "function" && guardRoom.wouldRegressReceipt(_this20.credentials.userId, event, receiptType)) {
        _this20.logger.debug("sendReceipt: skipping ".concat(receiptType, " for ").concat(event.getId(), " in ").concat(event.getRoomId(), " \u2014 ") + "would not advance the read position");
        return Promise.resolve({});
      }
  ...
  setRoomReadMarkers(roomId, rmEventId, rrEvent, rpEvent) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (rrEvent) {
        ...
        if (room && _this22.credentials.userId && typeof room.wouldRegressReceipt === "function" && room.wouldRegressReceipt(_this22.credentials.userId, rrEvent, ReceiptType.Read)) {
          rrEventId = undefined;
        } else {
      ...
      if (rpEvent) {
        ...
        if (room && _this22.credentials.userId && typeof room.wouldRegressReceipt === "function" && room.wouldRegressReceipt(_this22.credentials.userId, rpEvent, ReceiptType.ReadPrivate)) {
          rpEventId = undefined;
        } else {
   ...
   * on classic /sync).
   */
  serverSupportsSimplifiedSlidingSync() {
    var _this40 = this;
    return _asyncToGenerator(function* () {
      try {
        var {
          unstable_features: uf
        } = yield _this40.getVersions();
        return !!(uf !== null && uf !== void 0 && uf["org.matrix.simplified_msc3575"] || uf !== null && uf !== void 0 && uf["org.matrix.msc3575"] || uf !== null && uf !== void 0 && uf["org.matrix.msc4186"]);
      } catch (_unused2) {
        return false;
      }
    })();
  ...
  doesServerSupportExtendedProfiles() {
    var _this51 = this;
    return _asyncToGenerator(function* () {
      return (yield _this51.doesServerSupportUnstableFeature(UNSTABLE_MSC4133_EXTENDED_PROFILES)) || (yield _this51.doesServerSupportUnstableFeature(STABLE_MSC4133_EXTENDED_PROFILES));
    })();
  }
  ...
  getExtendedProfileRequestPrefix() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if ((yield _this52.isVersionSupported("v1.15")) || (yield _this52.doesServerSupportUnstableFeature("uk.tcpip.msc4133.stable"))) {
  ...
  getSlidingSync() {
    ...
    return (_this$clientOpts4 = this.clientOpts) === null || _this$clientOpts4 === void 0 ? void 0 : _this$clientOpts4.slidingSync;
  }
  ...
  supportsThreads() {
    ...
    return ((_this$clientOpts5 = this.clientOpts) === null || _this$clientOpts5 === void 0 ? void 0 : _this$clientOpts5.threadSupport) || false;
  }
  ...
  isFullLazyLoading() {
    ...
    return ((_this$clientOpts6 = this.clientOpts) === null || _this$clientOpts6 === void 0 ? void 0 : _this$clientOpts6.fullLazyLoading) || false;
  }
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        if (e instanceof MatrixError && e.errcode === "M_UNRECOGNIZED") {
          ...
          var {
            issuer
          } = yield _this71.http.request(Method.Get, "/auth_issuer", undefined, undefined, {
            prefix: ClientPrefix.Unstable + "/org.matrix.msc2965"
          });
