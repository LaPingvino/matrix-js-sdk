...
export class MatrixClient extends TypedEventEmitter {
  ...
  leave(roomId) {
    var _this25 = this;
    return _asyncToGenerator(function* () {
      var response = yield _this25.membershipChange(roomId, undefined, KnownMembership.Leave);
      ...
      _this25.applyLocalLeave(roomId);
      return response;
    })();
  }
  ...
  applyLocalLeave(roomId) {
    ...
    try {
      ...
      this.logger.warn("Failed to record local leave state for ".concat(roomId), e);
    }
  ...
  doesServerSupportThread() {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        var [threadUnstable, threadStable, listUnstable, listStable, fwdPaginationUnstable, fwdPaginationStable] = yield Promise.all([_this45.doesServerSupportUnstableFeature("org.matrix.msc3440"), _this45.doesServerSupportUnstableFeature("org.matrix.msc3440.stable"), _this45.doesServerSupportUnstableFeature("org.matrix.msc3856"), _this45.doesServerSupportUnstableFeature("org.matrix.msc3856.stable"), _this45.doesServerSupportUnstableFeature("org.matrix.msc3715"), _this45.doesServerSupportUnstableFeature("org.matrix.msc3715.stable")]);
        return {
  ...
  relations(roomId, eventId, relationType, eventType) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var fetchedEventType = eventType ? _this46.getEncryptedIfNeededEventType(roomId, eventType) : null;
      var [eventResult, result] = yield Promise.all([_this46.fetchRoomEvent(roomId, eventId), _this46.fetchRelations(roomId, eventId, relationType, fetchedEventType, opts)]);
      var mapper = _this46.getEventMapper();
      ...
      if (fetchedEventType === EventType.RoomMessageEncrypted) {
        ...
        yield Promise.all(allEvents.map(e => _this46.decryptEventIfNeeded(e)));
        if (eventType !== null) {
  ...
  loginRequest(data) {
    var _this47 = this;
    return _asyncToGenerator(function* () {
      return yield _this47.http.authedRequest(Method.Post, "/login", undefined, data);
    })();
  }
  ...
  logout() {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this48.http.authedRequest(Method.Post, "/logout");
    })();
  }
  ...
  requestLoginToken(auth) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this49.http.authedRequest(Method.Post, "/login/get_token", undefined,
      // no query params
      body, {
  ...
  createRoom(options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (invitesNeedingToken.length > 0 && (_this50$identityServe = _this50.identityServer) !== null && _this50$identityServe !== void 0 && _this50$identityServe.getAccessToken) {
        var identityAccessToken = yield _this50.identityServer.getAccessToken();
        if (identityAccessToken) {
      ...
      return _this50.http.authedRequest(Method.Post, "/createRoom", undefined, options);
    })();
  }
  ...
  setRoomReadMarkersHttpRequest(roomId, rmEventId, rrEventId, rpEventId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if ((yield _this51.doesServerSupportUnstableFeature("org.matrix.msc2285.stable")) || (yield _this51.isVersionSupported("v1.4"))) {
        content[ReceiptType.ReadPrivate] = rpEventId;
      }
      return _this51.http.authedRequest(Method.Post, path, undefined, content);
    })();
  }
  ...
  doesServerSupportExtendedProfiles() {
    var _this52 = this;
    return _asyncToGenerator(function* () {
      return (yield _this52.doesServerSupportUnstableFeature(UNSTABLE_MSC4133_EXTENDED_PROFILES)) || (yield _this52.doesServerSupportUnstableFeature(STABLE_MSC4133_EXTENDED_PROFILES));
    })();
  }
  ...
  getExtendedProfileRequestPrefix() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if ((yield _this53.isVersionSupported("v1.15")) || (yield _this53.doesServerSupportUnstableFeature("uk.tcpip.msc4133.stable"))) {
  ...
  getExtendedProfile(userId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this54.http.authedRequest(Method.Get, utils.encodeUri("/profile/$userId", {
        $userId: userId
      }), undefined, undefined, {
  ...
  getExtendedProfileProperty(userId, key) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var profile = yield _this55.http.authedRequest(Method.Get, utils.encodeUri("/profile/$userId/$key", {
        $userId: userId,
        $key: key
      }), undefined, undefined, {
  ...
  setExtendedProfileProperty(key, value) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this56.http.authedRequest(Method.Put, utils.encodeUri("/profile/$userId/$key", {
        $userId: userId,
        $key: key
      }), undefined, {
        [key]: value
  ...
  deleteExtendedProfileProperty(key) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this57.http.authedRequest(Method.Delete, utils.encodeUri("/profile/$userId/$key", {
        $userId: userId,
        $key: key
      }), undefined, undefined, {
  ...
  patchExtendedProfile(profile) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this58.http.authedRequest(Method.Patch, utils.encodeUri("/profile/$userId", {
        $userId: userId
      }), {}, profile, {
  ...
  setExtendedProfile(profile) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var userId = _this59.getUserId();
      yield _this59.http.authedRequest(Method.Put, utils.encodeUri("/profile/$userId", {
        $userId: userId
      }), {}, profile, {
        prefix: yield _this59.getExtendedProfileRequestPrefix()
      });
    })();
  }
  ...
  // eslint-disable-next-line camelcase
    ...
    return _asyncToGenerator(function* () {
      ...
      var data = {
        medium,
        address,
        id_server: _this62.getIdentityServerUrl(true)
      };
      return _this62.http.authedRequest(Method.Post, path, undefined, data);
    })();
  }
  ...
  getPushers() {
    var _this63 = this;
    return _asyncToGenerator(function* () {
      var response = yield _this63.http.authedRequest(Method.Get, "/pushers");

      // Migration path for clients that connect to a homeserver that does not support
      // MSC3881 yet, see https://github.com/matrix-org/matrix-spec-proposals/blob/kerry/remote-push-toggle/proposals/3881-remote-push-notification-toggling.md#migration
      if (!(yield _this63.doesServerSupportUnstableFeature("org.matrix.msc3881"))) {
  ...
  identityHashedLookup(addressPairs, identityAccessToken) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var hashes = yield _this64.getIdentityHashDetails(identityAccessToken);
      ...
      var response = yield _this64.http.idServerRequest(Method.Post, "/lookup", params, IdentityPrefix.V2, identityAccessToken);
  ...
  lookupThreePid(medium, address, identityAccessToken) {
    ...
    return _asyncToGenerator(function* () {
      ...
      // convert it manually.
      var response = yield _this65.identityHashedLookup([[address, medium]], identityAccessToken);
  ...
  bulkLookupThreePids(query, identityAccessToken) {
    ...
    return _asyncToGenerator(function* () {
      ...
      // function contract requires a V1 response. We therefore have to
      // convert it manually.
      var response = yield _this66.identityHashedLookup(
  ...
  encryptAndSendToDevice(eventType, devices, payload) {
    var _this67 = this;
    return _asyncToGenerator(function* () {
      if (!_this67.cryptoBackend) {
        throw new Error("Cannot encrypt to device event, your client does not support encryption.");
      }
      var batch = yield _this67.cryptoBackend.encryptToDeviceMessages(eventType, devices, payload);
      ...
      yield _this67.queueToDevice(batch);
    })();
  }
  ...
  unstableCreateFileTree(name) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return new MSC3089TreeSpace(_this68, roomId);
    })();
  }
  ...
  getRoomSummary(roomIdOrAlias, via) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        return yield _this69.http.authedRequest(Method.Get, path, {
          via
        }, undefined, paramOpts);
      } catch (e) {
        if (e instanceof MatrixError && e.errcode === "M_UNRECOGNIZED") {
          ...
          return yield _this69.http.authedRequest(Method.Get, _path, {
            via
          }, undefined, paramOpts);
        } else {
          throw e;
  ...
  whoami() {
    var _this70 = this;
    return _asyncToGenerator(function* () {
      return _this70.http.authedRequest(Method.Get, "/account/whoami");
    })();
  }
  ...
  timestampToEvent(roomId, timestamp, dir) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        return yield _this71.http.authedRequest(Method.Get, path, queryParams, undefined, {
          prefix: ClientPrefix.V1
        });
      } catch (err) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        if (e instanceof MatrixError && e.errcode === "M_UNRECOGNIZED") {
          ...
          var {
            issuer
          } = yield _this72.http.request(Method.Get, "/auth_issuer", undefined, undefined, {
            prefix: ClientPrefix.Unstable + "/org.matrix.msc2965"
          });
