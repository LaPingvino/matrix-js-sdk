...
var isShell = rec => {
  ...
  return ((_rec$data$timeline$le = (_rec$data$timeline = rec.data.timeline) === null || _rec$data$timeline === void 0 ? void 0 : _rec$data$timeline.length) !== null && _rec$data$timeline$le !== void 0 ? _rec$data$timeline$le : 0) === 0;
};
