...
export class RustCrypto extends TypedEventEmitter {
  ...
  encryptEvent(event, room) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (!encryptor) {
        ...
        var encEvent = room === null || room === void 0 || (_room$currentState = room.currentState) === null || _room$currentState === void 0 ? void 0 : _room$currentState.getStateEvents(EventType.RoomEncryption, "");
        if (encEvent) {
          yield _this.onCryptoEvent(room, encEvent);
          encryptor = _this.roomEncryptors[roomId];
        }
      }
      if (!encryptor) {
  ...
  getBackupDecryptor(backupInfo, privKey) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if ((backupInfo === null || backupInfo === void 0 ? void 0 : backupInfo.algorithm) != "m.megolm_backup.v1.curve25519-aes-sha2") {
        throw new Error("getBackupDecryptor: Unsupported algorithm ".concat(backupInfo === null || backupInfo === void 0 ? void 0 : backupInfo.algorithm));
      }
  ...
  userHasCrossSigningKeys() {
    var _arguments = arguments,
      _this10 = this;
    return _asyncToGenerator(function* () {
      var userId = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : _this10.userId;
      ...
      if (rustTrackedUser !== undefined) {
        ...
        var keyResult = yield _this10.downloadDeviceList(new Set([userId]));
  ...
  downloadDeviceList(untrackedUsers) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return yield _this13.http.authedRequest(Method.Post, "/_matrix/client/v3/keys/query", undefined, queryBody, {
        prefix: ""
      });
    })();
  }
  ...
  setDeviceVerified(userId, deviceId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var device = yield _this14.olmMachine.getDevice(new RustSdkCryptoJs.UserId(userId), new RustSdkCryptoJs.DeviceId(deviceId));
      if (!device) {
  ...
  crossSignDevice(deviceId) {
    var _this15 = this;
    return _asyncToGenerator(function* () {
      var device = yield _this15.olmMachine.getDevice(new RustSdkCryptoJs.UserId(_this15.userId), new RustSdkCryptoJs.DeviceId(deviceId));
      if (!device) {
  ...
  getCrossSigningStatus() {
    var _this28 = this;
    return _asyncToGenerator(function* () {
      var userIdentity = yield _this28.getOlmMachineOrThrow().getIdentity(new RustSdkCryptoJs.UserId(_this28.userId));
  ...
  requestVerificationDM(userId, roomId) {
    var _this31 = this;
    return _asyncToGenerator(function* () {
      var userIdentity = yield _this31.olmMachine.getIdentity(new RustSdkCryptoJs.UserId(userId));
  ...
  sendVerificationRequestContent(roomId, verificationEventContent) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var {
        event_id: eventId
      } = yield _this32.http.authedRequest(Method.Put, "/_matrix/client/v3/rooms/".concat(encodeURIComponent(roomId), "/send/m.room.message/").concat(encodeURIComponent(txId)), undefined, verificationEventContent, {
        prefix: ""
      });
      return eventId;
    })();
  ...
  requestOwnUserVerification() {
    var _this33 = this;
    return _asyncToGenerator(function* () {
      var userIdentity = yield _this33.olmMachine.getIdentity(new RustSdkCryptoJs.UserId(_this33.userId));
      if (userIdentity === undefined) {
  ...
  requestDeviceVerification(userId, deviceId) {
    var _this34 = this;
    return _asyncToGenerator(function* () {
      var device = yield _this34.olmMachine.getDevice(new RustSdkCryptoJs.UserId(userId), new RustSdkCryptoJs.DeviceId(deviceId));
      if (!device) {
  ...
  storeSessionBackupPrivateKey(key, version) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this36.backupManager.saveBackupDecryptionKey(RustSdkCryptoJs.BackupDecryptionKey.fromBase64(base64Key), version);
    })();
  }
  ...
  encryptToDeviceMessages(eventType, devices, payload) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this52.keyClaimManager.ensureSessionsForUsers(logger, Array.from(uniqueUsers).map(userId => new RustSdkCryptoJs.UserId(userId)));
      var batch = {
        batch: [],
      ...
      yield Promise.all(devices.map(/*#__PURE__*/function () {
        var _ref4 = _asyncToGenerator(function* (_ref3) {
          ...
          var device = yield _this52.olmMachine.getDevice(new RustSdkCryptoJs.UserId(userId), new RustSdkCryptoJs.DeviceId(deviceId));
          if (device) {
  ...
  shareRoomHistoryWithUser(roomId, userId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var bundle = yield _this55.getOlmMachineOrThrow().buildRoomKeyBundle(new RustSdkCryptoJs.RoomId(roomId));
      if (!bundle) {
      ...
      var req = _this55.getOlmMachineOrThrow().queryKeysForUsers([new RustSdkCryptoJs.UserId(userId)]);
      ...
      yield _this55.keyClaimManager.ensureSessionsForUsers(logger, [new RustSdkCryptoJs.UserId(userId)]);

      // 5. Send to-device messages to the recipient to share the keys.
      var requests = yield _this55.getOlmMachineOrThrow().shareRoomKeyBundleData(new RustSdkCryptoJs.UserId(userId), new RustSdkCryptoJs.RoomId(roomId), uploadResponse.content_uri, bundle.mediaEncryptionInfo, RustSdkCryptoJs.CollectStrategy.identityBasedStrategy());
  ...
  onSyncCompleted(syncState) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        yield _this61.outgoingRequestsManager.doProcessOutgoingRequests();
      } catch (e) {
        _this61.logger.warn("onSyncCompleted: Error processing outgoing requests", e);
      }
    })();
  }
